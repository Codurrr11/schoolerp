<?php
// modules/school/students/passed.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'edit') {
        ...
        try {
            ...
            $status_posted = $_POST['status'] ?? 'passed';
...
<div class="row align-items-center mb-4 g-3">
    <div class="col-12">
        <h2 class="mb-1 font-heading fw-extrabold">Passed Students</h2>
        <p class="text-xs text-muted mb-0">Directory of students who have completed their studies or passed out.</p>
    </div>
</div>
            ...
            <div class="teacher-card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-3 w-100 w-sm-auto ms-auto justify-content-end">
                    <div class="table-search-box m-0">
                        ...
                        <input type="text" placeholder="Search passed students..." id="studentSearchInput" class="table-search-input">
                    </div>
                ...
                <div class="table-responsive">
                    <?php if (empty($students)): ?>
                        <div class="p-5 text-center">
                            ...
                            <h5 class="fw-semibold mt-3">No Passed Students</h5>
                            <p class="text-xs text-muted mb-0">No student records are currently marked as Passed.</p>
                        </div>
                    <?php else: ?>
                        <form id="bulkDeleteForm" action="passed.php" method="POST" class="d-none">
                            ...
                            <tbody id="studentsTableBody">
                                ...
                                foreach ($students as $s): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="passed.php" method="POST" class="d-inline">
                                                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
...
<form id="deleteStudentForm" action="passed.php" method="POST" class="d-none">
    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
...
<!-- Include Edit Modal -->
<?php
// We output the Edit Student Details modal here, customized to submit to passed.php
?>
<div class="modal fade" id="editStudentModal" tabindex="-1" aria-labelledby="editStudentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="passed.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="class_id" id="edit_student_class_select" class="form-control-admin" required>
                                    <option value="">-- Select Classes --</option>
                                    <?php foreach ($all_classes as $c):
                                        // Package class sections data as a JSON string inside data attribute
